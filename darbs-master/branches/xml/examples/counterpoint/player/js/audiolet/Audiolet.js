...
//        this.inputs[0].connect(this.blockSizeLimiter);
        this.badValueDetector = new DiscontinuityDetector(audiolet);
        this.inputs[0].connect(this.badValueDetector);
        this.badValueDetector.connect(this.blockSizeLimiter);
